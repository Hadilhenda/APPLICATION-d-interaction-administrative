...
const ShowReunionshop = (props) => {
  ...
  const participer = (rowIndex) => {
    const id = reunionsRef.current[rowIndex].id
    if (window.confirm('Are you sure you wish to participe a this reunion ?')) {
      var data = {
        id_user: currentUser.id,
        id_reuni: id,
      }
      ParticipeDataService.create(data)
        .then((response) => {
...
export default ShowReunionshop
