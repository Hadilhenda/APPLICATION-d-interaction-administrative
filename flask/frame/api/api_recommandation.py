	...
	return jsonify([
		{
			...
			'domaine': recommandation.domaine,'specification': recommandation.specification,'retenu': recommandation.retenu,'etat': recommandation.etat,'date_ins': recommandation.date_ins,'createdAt': analyste.createdAt,'updatedAt': analyste.updatedAt
...
def create_recommandation():
	...
	return {
		'id': entry.id, 'titre': entry.titre, 'description': entry.description,
			'domaine': entry.domaine,'specification': entry.specification,'retenu': entry.retenu,'etat': entry.etat,'date_ins': entry.date_ins,'createdAt': entry.createdAt,'updatedAt': entry.updatedAt  
	}, 201
...
def update_recommandation(id):
	...
	recommandation.createdAt=data['createdAt']
	recommandation.updatedAt=data['updatedAt']
	
	db.session.commit()
	return jsonify({
		'id': recommandation.id, 'titre': recommandation.titre, 'description': recommandation.description,
			'domaine': recommandation.domaine,'specification': recommandation.specification,'retenu': recommandation.retenu,'etat': recommandation.etat,'date_ins': recommandation.date_ins,'createdAt': recommandation.createdAt,'updatedAt': recommandation.updatedAt
		})
