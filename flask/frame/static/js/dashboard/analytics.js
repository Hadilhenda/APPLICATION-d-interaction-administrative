;(function ($) {
  ...
  var dzChartlist = (function () {
    ...
    var chartBar2 = function () {
      var Jan_d = document.getElementById('Jan_d').value
      var Mai_d = document.getElementById('Mai_d').value
      var Fev_d = document.getElementById('Fev_d').value
      var Mars_d = document.getElementById('Mars_d').value
      var Avr_d = document.getElementById('Avr_d').value
      var Juin_d = document.getElementById('Juin_d').value
      var Juil_d = document.getElementById('Juil_d').value
      var Aout_d = document.getElementById('Aout_d').value
      var Sept_d = document.getElementById('Sept_d').value
      var Oct_d = document.getElementById('Oct_d').value
      var Nov_d = document.getElementById('Nov_d').value
      var Decm_d = document.getElementById('Decm_d').value
      var options = {
        series: [
          {
            name: 'series1',
    ...
    var widgetChart1 = function () {
      if (jQuery('#widgetChart1').length > 0) {
        const chart_widget_1 = document
          .getElementById('widgetChart1')
          .getContext('2d')
            ...
            datasets: [
              {
                ...
                data: [
                  8, 7, 6, 3, 2, 4, 6, 8, 12, 6, 12, 13, 10, 18, 14, 24, 16, 12,
                  19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21,
                  17,
                ],
              },
            ],
            ...
            datasets: [
              {
                ...
                data: [
                  19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21,
                  17, 12, 6, 12, 13, 10, 18, 14, 24, 16, 12, 8, 7, 6, 3, 2, 7,
                  6, 8,
                ],
              },
            ],
