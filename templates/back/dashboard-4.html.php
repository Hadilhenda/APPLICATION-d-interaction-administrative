                              ...
                              <div class="iq-card-body">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-left">
                                       ...
                                       <h3 class="mb-0 line-height">183,325</h3>
                                    </div>
                              ...
                              <div class="iq-card-body">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-left">
                                       ...
                                       <h3 class="mb-0 line-height">79,908</h3>
                                    </div>
                              ...
                              <div class="iq-card-body">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <div class="text-left">
                                       ...
                                       <h3 class="mb-0 line-height">7,177</h3>
                                    </div>
                        ...
                        <div class="iq-card-body">
                           <div class="table-responsive">
                                 <table class="table mb-0 table-borderless">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td><img src="images/small/china.png" class="img-fluid" alt="country-flag"> China</td>
                                          <td>80,967</td>
                                          <td>972</td>
                                          <td>3248</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/france.png" class="img-fluid" alt="country-flag"> France</td>
                                          <td>10,995</td>
                                          <td>245</td>
                                          <td>372</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/germany.png" class="img-fluid" alt="country-flag"> Germany</td>
                                          <td>15,320</td>
                                          <td>242</td>
                                          <td>44</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/iran.png" class="img-fluid" alt="country-flag"> Iran</td>
                                          <td>18,407</td>
                                          <td>520</td>
                                          <td>1284</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/italy.png" class="img-fluid" alt="country-flag"> Italy</td>
                                          <td>41,035</td>
                                          <td>10,600</td>
                                          <td>3405</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/netherlands.png" class="img-fluid" alt="country-flag"> Netherlands</td>
                                          <td>2460</td>
                                          <td>24</td>
                                          <td>76</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/norway.png" class="img-fluid" alt="country-flag"> Norway</td>
                                          <td>789</td>
                                          <td>135</td>
                                          <td>35</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/south-koria.png" class="img-fluid" alt="country-flag"> South Korea</td>
                                          <td>1200</td>
                                          <td>500</td>
                                          <td>600</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/spain.png" class="img-fluid" alt="country-flag"> Spain</td>
                                          <td>18,077</td>
                                          <td>150</td>
                                          <td>831</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/sweden.png" class="img-fluid" alt="country-flag"> Sweden</td>
                                          <td>800</td>
                                          <td>250</td>
                                          <td>25</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/switzerlands.png" class="img-fluid" alt="country-flag"> SwizerLand</td>
                                          <td>4222</td>
                                          <td>125</td>
                                          <td>43</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/usa.png" class="img-fluid" alt="country-flag"> United States</td>
                                          <td>14354</td>
                                          <td>150</td>
                                          <td>277</td>
                                       </tr>
                                       <tr>
                                          <td><img src="images/small/india.png" class="img-fluid" alt="country-flag"> India</td>
                                          <td>197</td>
                                          <td>50</td>
                                          <td>4</td>
                                       </tr>
                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        ...
                        <div class="iq-card-body">
                           <div class="media mb-4">
                              <img src="images/page-img/45.png" class="align-self-start mr-3 avatar-80" alt="blog-img">
                           ...
                           <div class="media mb-4">
                              <img src="images/page-img/46.png" class="align-self-start mr-3 avatar-80" alt="blog-img">
                              <div class="media-body">
                           ...
                           <div class="media mb-4">
                              <img src="images/page-img/47.png" class="align-self-start mr-3 avatar-80" alt="blog-img">
                              <div class="media-body">
                           ...
                           <div class="media">
                              <img src="images/page-img/48.png" class="align-self-start mr-3 avatar-80" alt="blog-img">
                              <div class="media-body">
                  ...
                  <div class="col-sm-12">
                     <div id="contact-slider" class="row">
                        <div class="col-sm-6 col-md-3">
                              <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                 <div class="iq-card-body">
                                    <img class="arrow-img w-auto mb-3" src="images/small/china.png" alt="iconflag">
                         ...
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/france.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                         ...
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/germany.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                         ...
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/iran.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                         ...
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/italy.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line Italy</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/netherlands.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line Netherlands</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/norway.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line Norway</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/south-koria.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line South Korea</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/spain.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line Spain</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/sweden.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line Sweden</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/switzerlands.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line SwizerLand</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/usa.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line United States</p>
                                 </div>
                             </div> 
                         </div>
                         <div class="col-sm-6 col-md-3">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="iq-card-body">
                                 <img class="arrow-img w-auto mb-3" src="images/small/india.png" alt="iconflag">
                                   <h5 class="contact-number">
                                       <i aria-hidden="true" class="ion ion-android-call"></i>
                                       + 1 800 324 2323
                                   </h5><p class="mb-0">Help line  India</p>
                                 </div>
                             </div> 
                         </div>
                     </div>
                  ...
                  <div class="col-sm-12">
                     <div id="blog-slider" class="row">
                        <div class="col-sm-4">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="image-block">
                                 <img src="images/page-img/40.png" class="img-fluid w-100" alt="blog-img">
                              </div>
                              <div class="iq-card-body">
                        ...
                        <div class="col-sm-4">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="image-block">
                                 <img src="images/page-img/41.png" class="img-fluid w-100" alt="blog-img">
                              </div>
                              <div class="iq-card-body">
                                 <div class="blog-description">
                                    <div class="blog-meta"><a href="#">March 21, 2020</a></div>
                                    <h4 class="mb-2">Latest coronavirus updates</h4>
                                    <p>ABC Action News is committed to providing Tampa Bay area residents all of the updates on the coronavirus, COVID-19, and the impact it's having on our way of life. To help you stay on top of it all, we'll be updating this daily blog as we continue to get through this together.</p>
                                    <a href="#">Read More <i class="ri-arrow-right-s-line"></i></a>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-sm-4">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="image-block">
                                 <img src="images/page-img/42.png" class="img-fluid w-100" alt="blog-img">
                              </div>
                              <div class="iq-card-body">
                                 <div class="blog-description">
                                    <div class="blog-meta"><a href="#">March 21, 2020</a></div>
                                    <h4 class="mb-2">False Hope about Coronavirus</h4>
                                    <p>While patients can and do recover from coronavirus infections, there are currently no approved treatments that are known to work against COVID-19. He said at his press briefing yesterday, that two drugs, hydroxychloroquine and remdesivir</p>
                                    <a href="#">Read More <i class="ri-arrow-right-s-line"></i></a>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-sm-4">
                           <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                              <div class="image-block">
                                 <img src="images/page-img/43.png" class="img-fluid w-100" alt="blog-img">
                              </div>
                              <div class="iq-card-body">
                                 <div class="blog-description">
                                    <div class="blog-meta"><a href="#">March 21, 2020</a></div>
                                    <h4 class="mb-2">Coronavirus in Maine Blog</h4>
                                    <p>This now includes cases formerly identified as presumptive positive. This classification applies to samples sent by a health provider directly to HETL that test positive and to samples from non-governmental labs for which HETL validates positive results. </p>
                                    <a href="#">Read More <i class="ri-arrow-right-s-line"></i></a>
                                 </div>
                              </div>
                           </div>
