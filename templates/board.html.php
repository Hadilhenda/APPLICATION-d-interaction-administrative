 ...
 <input type='hidden' value=<?=$mars?> id='mars'>
 <input type='hidden' value=<?=$avr?> id='avr'>
 <input type='hidden' value=<?=$mai?> id='mai'>
 <input type='hidden' value=<?=$juin?> id='juin'>
 <input type='hidden' value=<?=$juil?> id='juil'>
 <input type='hidden' value=<?=$aout?> id='aout'>
 <input type='hidden' value=<?=$sep?> id='sep'>
 <input type='hidden' value=<?=$oct?> id='oct'>
 <input type='hidden' value=<?=$nov?> id='nov'>
 <input type='hidden' value=<?=$dec?> id='dec'>
 

 <input type='hidden' value='<?=$jan_dc?>' id='jan_dc'>
 <input type='hidden' value=<?=$fev_dc?> id='fev_dc'>
 <input type='hidden' value=<?=$mars_dc?> id='mars_dc'>
 <input type='hidden' value=<?=$avr_dc?> id='avr_dc'>
 <input type='hidden' value=<?=$mai_dc?> id='mai_dc'>
 <input type='hidden' value=<?=$juin_dc?> id='juin_dc'>
 <input type='hidden' value=<?=$juil_dc?> id='juil_dc'>
 <input type='hidden' value=<?=$aout_dc?> id='aout_dc'>
 <input type='hidden' value=<?=$sep_dc?> id='sep_dc'>
 <input type='hidden' value=<?=$oct_dc?> id='oct_dc'>
 <input type='hidden' value=<?=$nov_dc?> id='nov_dc'>
 <input type='hidden' value=<?=$dec_dc?> id='dec_dc'>

  <input type='hidden' value='<?=$jan_Covid?>' id='jan_Covid'>
   <input type='hidden' value=<?=$fev_Covid?> id='fev_Covid'>
 <input type='hidden' value=<?=$mars_Covid?> id='mars_Covid'>
 <input type='hidden' value=<?=$avr_Covid?> id='avr_Covid'>
 <input type='hidden' value=<?=$mai_Covid?> id='mai_Covid'>
 <input type='hidden' value=<?=$juin_Covid?> id='juin_Covid'>
 <input type='hidden' value=<?=$juil_Covid?> id='juil_Covid'>
 <input type='hidden' value=<?=$aout_Covid?> id='aout_Covid'>
 <input type='hidden' value=<?=$sep_Covid?> id='sep_Covid'>
 <input type='hidden' value=<?=$oct_Covid?> id='oct_Covid'>
 <input type='hidden' value=<?=$nov_Covid?> id='nov_Covid'>
 <input type='hidden' value=<?=$dec_Covid?> id='dec_Covid'>
            ...
            <div class="container-xxl">
                    ...
                    <div class="col-md-12 col-lg-8 col-xl-8">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Citoyens Statistics</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total Citoyens</h6>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total décès</h6>
                                                <span class="text-muted"><?=$deces?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total naissance</h6>
                                                <span class="text-muted"><?=$nnvalide?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Covid   </h6>
                                                <span class="text-muted"><?=$Covid?></span> 
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-4 col-sm-6">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-xl-8 col-lg-12 flex-column">
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Satistique chaque moins </h6>
                            </div>
                            <div class="card-body">
